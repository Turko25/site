          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="virgül ile ayırın (örn: sigorta, kasko)"
            ...
            <div>
              ...
              <div className="border rounded-lg p-2 min-h-[400px] bg-gray-50">
                <Editor 
            ...
            <button
              type="submit"
              disabled={loading}
              className={`bg-blue-600 text-white px-8 py-3 rounded-lg w-full font-semibold transition ${loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'}`}
            >
